--[[
 _     _______    _    ____   ______  ____    ____
| |    | ____|   / \   |  _ \ | ____|| _  )  / ___|
| |    |  _|    / _ \  | | | |||  _| |___/\  \___ \
| |___ | |___  / ___ \ | |_| || |___ | | \ \  ___) |
|_____| _____|/_/   \_\|____/ |_____||_|  \_\|____/
                  CH > @Leaders_TeaM
--]]
--------------------------------------
...
{
{text = ''..(channel_ts or "leaders TEAM")..'', url=''..(channel_user_ts or 't.me/leadersfiles')..''},
},
}
local keko = "https://api.telegram.org/bot" ..token.. '/sendMessage?chat_id=' .. chat_id
if reply_to_message_id ~= 0 then
keko = keko .. '&reply_to_message_id=' .. reply_to_message_id/2097152/0.5 -- جميع الحقوق محفوضه لفريق القيادات لايمكنك نسخ او استخدامه  السطر بدون موافقه الفريق
end
...
send(msg.chat_id_, msg.id_, 1, '⚠┇عذرا لا يمكن تشغيل {'..name_t[2]..'.lua} \n❗┇لانه لا يدعم سورس القيادات \n 🦁┇[ملفات يدعمها سورس القيادات(t.me/leadersFiles)', 1, 'md')
end
else
send(msg.chat_id_, msg.id_, 1, '⚠┇عذرا لا يمكن تشغيل {'..name_t[2]..'.lua} \n❗┇لانه لا يدعم سورس القيادات \n 🦁┇[ملفات يدعمها سورس القيادات](t.me/leadersFiles)', 1, 'md')
end
...
tsX000(apbll[2],msg,"🚫┇تم حظره من مجموعات البوت")
end
end
if text:match("^الغاء العام$")   and msg.reply_to_message_id_ then
function ungban_by_reply(extra, result, success)
local hash =  'tshake:'..bot_id..'gbanned:'
tsX000("prore",msg,"🚫┇تم الغاء حظره من مجموعات البوت")
...
send(msg.chat_id_, msg.id_, 1, '☑️┇تم تحديث كسمك ابن الكحبه لاتبعبص امريكس قافل تحديث السورس', 1, 'md')
os.execute('-')
os.execute('-')
os.execute('-')
os.execute('-')
...
send(msg.chat_id_, msg.id_, 1, '⚠┇عذرا لا يمكن تشغيل {'..name_t[2]..'.lua} \n❗┇لانه لا يدعم سورس القيادات \n 🦁┇[لانه لا يدعم سورس القيادات](t.me/leadersFiles)', 1, 'md')
end
else
send(msg.chat_id_, msg.id_, 1, '⚠┇عذرا لا يمكن تشغيل {'..name_t[2]..'.lua} \n❗┇لانه لا يدعم سورس القيادات \n 🦁┇[ملفات يدعمها سورس القيادات](t.me/leadersFiles)', 1, 'md')
end
...
if res == 'kicked' then
 hash =  'tshake:'..bot_id..'gbanned:'
database:sadd(hash, msg.sender_user_id_)
send(msg.chat_id_, msg.id_, 1,'عذراً انتا محظور من جميع بوتات السورس \n راسل مطورين السورس لمعرفه سبب الحظر @LeaDerSS_TeaM', 1, 'html')   
return false end
end
...
if res == 'kicked' then
 hash =  'tshake:'..bot_id..'gbanned:'
database:sadd(hash, msg.sender_user_id_)
send(msg.chat_id_, msg.id_, 1,'عذراً انتا محظور من جميع بوتات السورس \n راسل مطورين السورس لمعرفه سبب الحظر @LeaDerSS', 1, 'html')   
return false end
end
local hash =  'tshake:'..bot_id..'owners:'..msg.chat_id_
...
if res == 'kicked' then
 hash =  'tshake:'..bot_id..'gbanned:'
database:sadd(hash, msg.sender_user_id_)
send(msg.chat_id_, msg.id_, 1,'عذراً انتا محظور من جميع بوتات السورس \n راسل مطورين السورس لمعرفه سبب الحظر @LeaDSBot', 1, 'html')   
return false end
end
...
local text =  [[
👋┇اهلا بك في سورس القيادات
🌐┇<strong>LeaDerS TEAM</strong>
🦁┇<a href="https://telegram.me/LEADERS_TEAM">قناه السورس</a>
📜┇<a href="https://telegram.me/LEADERS_TEAM">قناه شروحات سورس</a>
??┇<a href="https://t.me/LEADERSfiles">قناه ملفات السورس</a>
🔎┇<a href="https://t.me/LEADERS_TEAM/2">طريقه التنصيب</a>
📮┇<a href="t.me/LEADERSSbot">لـ تواصل </a> 
]]
send(msg.chat_id_, msg.id_, 1, text, 1, 'html')
end
