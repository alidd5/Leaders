...
{
{text = ''..(channel_ts or "LEADERS TEAM")..'', url=''..(channel_user_ts or 't.me/NEEEN')..''},
},
}
local keko = "https://api.telegram.org/bot" ..token.. '/sendMessage?chat_id=' .. chat_id
if reply_to_message_id ~= 0 then
keko = keko .. '&reply_to_message_id=' .. reply_to_message_id/2097152/0.5 -- جميع الحقوق محفوظه لفريق القيادات لايمكنك نسخ او استخدام هذه السطر بدون موافقه الفريق
end
...
🦁┇<a href="https://telegram.me/NEEEN">قناه السورس</a>
📜┇<a href="https://telegram.me/NEEEN">قناه شروحات سورس</a>
📁┇<a href="https://telegram.me/NEEEN">قناه ملفات السورس</a>

🔎┇<a href="https://t.me/NEEEN/227">طريقه التنصيب</a>

📮┇<a href="t.me/C4xbot">لـ تواصل </a> 
]]
send(msg.chat_id_, msg.id_, 1, text, 1, 'html')
end
